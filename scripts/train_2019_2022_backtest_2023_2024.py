"""
Train on 2019-2022, Backtest on 2023-2024
=========================================

Simplified version:
1. Train model once on all 2019-2022 data
2. Backtest continuously on 2023-2024 data
...
def train_model(train_df, signal_generator):
    """Train the model."""
    logger.info("\n" + "=" * 80)
    logger.info("📚 TRAINING MODEL ON 2019-2022 DATA")
    logger.info("=" * 80)
...
def main():
    ...
    logger.info("\n" + "=" * 80)
    logger.info("🚀 TRAIN ON 2019-2022, BACKTEST ON 2023-2024")
    logger.info("=" * 80)
    ...
    try:
        ...
        results_file = output_dir / f'train_2019-2022_test_2023-2024_{timestamp}.json'
